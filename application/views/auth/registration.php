            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <?php echo form_open('Auth/registration', array('class' => 'user')); ?>
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="text" name="name" class="form-control form-control-user" id="name" placeholder="Full Name" value="<?php echo set_value('name'); ?>"><?php echo form_error('name', '<small class="text-danger">', '</small>'); ?>
